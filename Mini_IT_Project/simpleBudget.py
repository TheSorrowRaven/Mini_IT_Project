...
class Application():
    ...
    def prompt_income(self):
        ...
        for k in incomedict:
            print(k + ': ', 'RM ' + str(incomedict[k]))
        print('Total user income: ', 'RM ' + str(self.income))
        self.prompt_expense()
    ...
    def prompt_expense(self):
        ...
        for k in expensedict:
            print(k + ': ', 'RM ' + str(expensedict[k]))
        print('Total user expenses: ', 'RM ' + str(self.expenses))
        self.uservalue()

    def uservalue(self):
        valoutput = self.income - self.expenses
        if valoutput < 0:
            print('You are in the negative, you have a deficit of ' + 'RM ' + str(valoutput))
        if valoutput == 0:
            print('You have broken even, you are spending exactly as much as you make.')
        if valoutput > 0:
            print('You are in the positive, you have a surplus of ' + 'RM ' + str(valoutput))
